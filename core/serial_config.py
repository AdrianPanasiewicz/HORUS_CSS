...
class SerialConfigDialog(QDialog):
    def __init__(self, parent=None):
        ...
        server_layout.addWidget(self.ip_input, 0, 1, alignment=Qt.AlignmentFlag.AlignRight)

        server_layout.addWidget(QLabel("Port serwera:"), 1, 0)
        self.port_input = QLineEdit()
        self.port_input.setText("65432")
        self.port_input.setFixedWidth(220)
        server_layout.addWidget(self.port_input, 1, 1,  alignment=Qt.AlignmentFlag.AlignRight)
